...
Desafio
----
Faça um programa que leia o valor da dívida de várias pessoas. Para cada pessoa, o programa deve calcular e exibir: valor da dívida, valor dos juros, quantidade de parcelas e valor da parcela (juros simples), como mostra o exemplo abaixo. O programa termina quando o valor da dívida for igual -1.
